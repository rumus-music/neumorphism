...
function watch() {
  ...
  gulp.watch(["_sass/*.scss"], gulp.series(styles, jekyll, browserSyncReload));
  gulp.watch(["_js/*.js"], gulp.series(scripts, jekyll, browserSyncReload));
}
...
var serve = gulp.series(
  compile,
  jekyll,
  gulp.parallel(browserSyncServe, watch)
);
